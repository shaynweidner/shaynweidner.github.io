...
library(MASS)
set.seed(1234)
MyData <- as.data.frame(mvrnorm(n=1000,mu=c(2,3),Sigma = matrix(c(1,0,0,1),nrow=2)
                 ))
...
```
     Norm1     Norm2
1 3.205333 1.7929343
2 1.698533 3.2774292
3 3.539145 4.0844412
4 1.364629 0.6543023
5 1.297048 3.4291247
6 3.905883 3.5060559
```
